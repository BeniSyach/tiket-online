            ...
            <div class="p-4 bg-white shadow-2xl border-2 border-gray-100 rounded max-w-5xl mx-auto">
                <div class="flex flex-col md:flex-row gap-2">
                    ...
                    <div class="text-md flex-1">
                        ...
                        <a href="{{ route('page.show', ['page' => 'cookiepolicy']) }}" class="underline">
                            {{ __('website.Learn more') }}.</a>
                    </div>
    ...
    <div class="w-full justify-center flex flex-col main-content">
        ...
        @if ($setting->getValue('G_WHATSAPP_FLOAT_ENABLE') == 1)
            <div class="fixed z-10 bottom-2 right-5">
                <a href="{{ $setting->getValue('G_WHATSAPP_URL') }}" target="_blank"
                    class="flex flex-row items-center justify-center gap-2 bg-green-500 rounded-2xl px-4 py-2 scale-100 hover:scale-110 text-white">
